...
class SearchPlace < HomePage
  ...
  def facebook_icon
    @browser.span(class: "iconav-facebook")
  end

  def twitter_icon
    @browser.span(class: "iconav-twitter-2")
  end

  def google_plus_icon
    @browser.span(class: "iconav-googleplus")
  end
  ...
  def click_google_plus_icon
    google_plus_icon.click
  end
end